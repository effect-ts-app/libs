import { TypeId } from "@effect-app/schema"
...
export interface ClientConfig extends SqliteClientConfig {
  readonly concurrentTransactions?: boolean | undefined
}
...
export const make = (
  ...
  Effect.gen(function*() {
    ...
    const transformRows = Statement
      .defaultTransforms(
        options.transformResultNames as any
      )
      .array
    ...
    return Object.assign(
      Client.make({
        acquirer,
        compiler,
        beginTransaction: options.concurrentTransactions ? "BEGIN CONCURRENT" : "BEGIN",
        transactionAcquirer,
        spanAttributes: [
