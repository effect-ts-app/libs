...
export const PositiveInt = S.Int.pipe(S.positive(), fromBrand(nominal<PositiveIntBrand>())).withDefaults
...
export const NonNegativeInt =
  S.Int.pipe(S.greaterThanOrEqualTo(0), fromBrand(nominal<NonNegativeIntBrand>())).withDefaults
export type NonNegativeInt = S.Schema.To<typeof NonNegativeInt>

export interface IntBrand extends Simplify<B.Brand<"Int">> {}
export const Int = S.Int.pipe(fromBrand(nominal<IntBrand>())).withDefaults
