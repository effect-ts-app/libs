import * as Schema from "@effect-app/schema"
...
//  */
// export const { condemnCustom } = Schema

// /**
//  * @tsplus getter ets/Schema/Parser condemnLeft
//  */
// export const { condemnLeft } = Schema

// /**
//  * @tsplus getter ets/Schema/Schema parseCondemnCustom
//  */
// export const { parseCondemnCustom } = Schema
...
//  */
// export const { parseECondemnDie } = Schema

// /**
//  * @tsplus getter ets/Schema/Schema parseECondemnCustom
//  */
// export const { parseECondemnCustom } = Schema

// /**
//  * @tsplus getter ets/Schema/Schema parseCondemnLeft
//  */
// export const { parseCondemnLeft } = Schema
...
//  */
// export const { parseCondemn } = Schema

// /**
//  * @tsplus getter ets/Schema/Schema parseECondemn
//  */
// export const { parseECondemn } = Schema
